...
class UCMDataLoader():
    ...
    def read_matdataset(self):
        ...
        tsl = np.array(test_seen_label)
        tuf = np.array(test_unseen_feature)
        tul = np.array(test_unseen_label)
        ...
        #scipy.io.savemat('gt_train_features.mat', {'gt_train_features':tf, 'gt_train_labels':tl})
        #scipy.io.savemat('gt_test_seen_features.mat', {'gt_test_seen_features':tsf, 'gt_test_seen_labels':tsl})
        #scipy.io.savemat('gt_test_unseen_features.mat', {'gt_test_unseen_features':tuf, 'gt_test_unseen_labels':tul})
